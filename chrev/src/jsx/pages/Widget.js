...
import Pie from "../components/Dhrev/WidgetBasic/pie";
import LineChart from "../components/Dhrev/WidgetBasic/line3";
import LineChart4 from "../components/Dhrev/WidgetBasic/line4";
import LineChart6 from "../components/Dhrev/WidgetBasic/line6";
import LineChart3 from "../components/Dhrev/WidgetBasic/line3";
import BarChart2 from "../components/Dhrev/WidgetBasic/bar2";
import BarChart3 from "../components/Dhrev/WidgetBasic/bar3";
import LiveBar from "../components/Dhrev/WidgetBasic/bar4";
import RealTime from "../components/Dhrev/WidgetBasic/realtime";
import BarChartNoPadding from "../components/Dhrev/WidgetBasic/BarChartNoPadding";
import PositiveNagetive from "../components/Dhrev/WidgetBasic/PositiveNagative";
import BarChart from "../components/Dhrev/WidgetBasic/Bar";
// Data
      ...
      <div className="row">
              ...
              >
                <ul className="timeline">
                  ...
                  <li>
                    <div className="timeline-panel">
                      <div className="media mr-2 media-success">
                        <img alt="image" width="50" src={avatar2} />
                      </div>
                      <div className="media-body">
                        <h5 className="mb-1">
                          Jack Ronan{" "}
                  ...
                  <li>
                    <div className="timeline-panel">
                      <div className="media mr-2 media-primary">
                        <img alt="image" width="50" src={avatar3} />
                      </div>
                      <div className="media-body">
                        <h5 className="mb-1">
                          Oscar Weston{" "}
        ...
        <div className="col-xl-4 col-lg-6 col-sm-6">
          <div className="card active_users">
            <div className="card-header bg-success border-0 d-block pb-0">
                ...
                <div className="card-body text-center">
                  <div className="ico-sparkline">
                    <Sparklines data={sampleData}>
                      <SparklinesBars style={{ fill: "#21B731" }} />
                    </Sparklines>
                  </div>
                </div>
              </div>
                ...
                <div className="card-body text-center">
                  <div className="ico-sparkline">
                    <div id="composite-bar">
                      <Sparklines data={sampleData}>
                        <SparklinesBars style={{ fill: "#222FB9" }} />
                      </Sparklines>
                    </div>
                  </div>
                </div>
              ...
              <div className="widget-media">
                <ul className="timeline">
                  <li>
                    <div className="timeline-panel">
                      <div className="media mr-2">
                        <img alt="image" width="50" src={avatar4} />
                      </div>
                      <div className="media-body">
                        <h5 className="mb-1">Dr sultads Send you Photo</h5>
                        <small className="d-block">
